...
<!-- injecte un objet exception si il existe -->
      ...
      <div class="intro">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            ...
            <span class="section-heading-lower">Exception et ErrorData</span>
          </h2>
          <p class="mb-3 font-weight-bold">Exception : <%= exception %></p>
          <p class="mb-3 font-weight-bold">ErrorData : <%= pageContext.getErrorData().getStatusCode() %></p>
          <p class="mb-3 font-weight-bold">ErrorData : <%= pageContext.getErrorData().getRequestURI() %></p>
        </div>
      </div>
    </div>
  </section>
